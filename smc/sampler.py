...
class SMCsampler(object):
    ...
    def resample(self, axes_angles = False):
    ...
    def MH(self, num_iters, axes_angles = False):
        ...
        for iter in range(num_iters):
            ...
            if axes_angles == False:
                log_numerator = self.log_target(self.counts, fluors_proposed, locs_proposed, self.axes, self.angles, self.temperature_prev)
            ...
            if iter == 0:
                if axes_angles == False:
                    log_denominator = self.log_target(self.counts, fluors_prev, locs_prev, self.axes, self.angles, self.temperature_prev)
