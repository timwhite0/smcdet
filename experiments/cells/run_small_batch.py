...
torch.save(posterior_mean_count, "results/small_batch_posterior_mean_count.pt")
torch.save(posterior_mean_total_fluor, "results/small_batch_posterior_mean_total_fluor.pt")
torch.save(reconstructed_image, "results/small_batch_reconstructed_image.pt")
torch.save(runtime, "results/small_batch_runtime.pt")
torch.save(num_iters, "results/small_batch_num_iters.pt")
#################################