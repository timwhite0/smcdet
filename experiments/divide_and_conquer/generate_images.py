...
imagemodel = ImageModel(image_height = image_dim,
...
flux_stdev = 15000
pad = 2
prior = StarPrior(max_objects = max_objects + 2,
...
true_counts, true_locs, true_fluxes, images = imagemodel.generate(Prior = prior,
