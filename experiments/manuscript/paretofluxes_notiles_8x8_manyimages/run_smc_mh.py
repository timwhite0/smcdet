...
for b in range(num_batches):
    ...
    locs = torch.zeros([batch_size, num_catalogs, prior.max_objects + 1, 2])
    fluxes = torch.zeros([batch_size, num_catalogs, prior.max_objects + 1])
    ...
    for i in range(batch_size):
        ...
        sampler = SMCsampler(
            ...
            ess_threshold=0.5 * num_catalogs_per_count,
