...
sep_estimated_total_flux = torch.zeros(num_images)
...
for img in range(num_images):
    ...
    sep_estimated_total_flux[img] = sep_flux.sum()
...
smc_posterior_mean_total_flux = torch.zeros(num_images)
...
for img in range(num_images):
    ...
    smc_posterior_mean_total_flux[img] = smc.posterior_mean_total_flux
...
torch.save(smc_posterior_mean_total_flux, "results/smc_posterior_mean_total_flux.pt")
